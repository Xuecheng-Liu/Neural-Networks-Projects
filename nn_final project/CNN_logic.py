...
def load_original_data():
    ...
    """
    import os
    data_folder = "/Users/paige/Documents/___Senior Year/SPRING/Neural/genres_original"
    ...
    for sub_folder in genre_folders:
        ...
        for audio_name in audio_files:
            ...
            if x.shape[0] < 30 * sr:
                x = np.append(x, np.zeros(30*sr - x.shape[0])) # ensure all files are exactly the same length
